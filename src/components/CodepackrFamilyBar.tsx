    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-9.5 flex items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2.5 shrink-0">
          ...
          >
            <div className="relative flex items-center justify-center size-5 rounded-md bg-gradient-to-br from-amber-600 via-orange-600 to-indigo-600 p-0.5 shadow-xs group-hover:scale-105 transition-transform">
