 ...
 *
 * Hierarchy students use:
 *   Subjects → one Subject → Topics (themes / sections / articles) → Practice
 *
 * All 19 AIBE subjects are listed. Content (MCQs) can be filled over time.
 * Priority groups drive home / subjects list UX.
 */
...
export interface LawTopic {
  id: string
  name: string
  /** theme | article | section | chapter | doctrine | act */
  type: TopicType
  /** e.g. "Arts 12–35", "Ss. 100–113 BNS", "Order VII" */
  range?: string
  /** Short exam tip or focus note */
  note?: string
...
export interface LawSubjectMeta {
  ...
  /** Approx AIBE question count */
  aibeQuestions: number
  /** Bare Acts students should keep open */
  bareActs: string[]
  /** One-line description for subject page */
  description: string
  /** Search keywords */
  keywords: string[]
  /** Lucide icon name */
  icon: string
  topics: LawTopic[]
  /** Optional: link to existing MCQ subject key in types/questions */
...
export const SUBJECTS: LawSubjectMeta[] = [
    ...
    topics: [
      {
        ...
        name: 'Preamble',
        type: 'theme',
        note: 'Nature of Constitution; key words tested in MCQs',
        keywords: ['preamble', 'sovereign', 'socialist', 'secular'],
        highYield: true,
      },
      {
        ...
        type: 'theme',
        range: 'Arts 12–35',
        note: 'Part III — core of AIBE constitutional questions',
        keywords: ['fundamental rights', 'part iii', 'article 12', 'article 13'],
        highYield: true,
      },
      {
        id: 'art-14',
        name: 'Article 14 — Equality',
        type: 'article',
        range: 'Art 14',
        keywords: ['equality', 'article 14', 'reasonable classification'],
        highYield: true,
      },
      {
        id: 'art-19',
        ...
        type: 'article',
        range: 'Art 19',
        keywords: ['freedom of speech', 'article 19', 'reasonable restrictions'],
        highYield: true,
      },
      {
        id: 'art-21',
        name: 'Article 21 — Life & Personal Liberty',
        type: 'article',
        range: 'Art 21',
        note: 'Expanded by Maneka Gandhi and later cases',
        keywords: ['article 21', 'life', 'liberty', 'due process'],
        highYield: true,
      },
      {
        id: 'art-32-226',
        name: 'Writs (Arts 32 & 226)',
        type: 'theme',
        range: 'Arts 32, 226',
        note: 'Habeas corpus, mandamus, prohibition, certiorari, quo warranto',
        keywords: ['writs', 'article 32', 'article 226', 'habeas corpus'],
        highYield: true,
      },
      {
        id: 'dpsp',
        name: 'Directive Principles (DPSP)',
        type: 'theme',
        range: 'Part IV',
        keywords: ['dpsp', 'directive principles', 'part iv'],
      },
      {
        id: 'fundamental-duties',
        name: 'Fundamental Duties',
        type: 'theme',
        range: 'Part IVA, Art 51A',
        keywords: ['fundamental duties', 'article 51a'],
      },
      {
        id: 'centre-state',
        name: 'Centre–State Relations',
        type: 'theme',
        note: 'Legislative, administrative, financial',
        keywords: ['federalism', 'centre state', 'union list', 'concurrent list'],
      },
      {
        id: 'emergency',
        ...
        type: 'theme',
        range: 'Arts 352–360',
        keywords: ['emergency', 'article 352', 'article 356'],
      },
      {
        id: 'amendment',
        ...
        type: 'theme',
        range: 'Art 368',
        keywords: ['amendment', 'article 368'],
      },
      {
        id: 'basic-structure',
        name: 'Basic Structure Doctrine',
        type: 'doctrine',
        note: 'Kesavananda Bharati and later cases',
        keywords: ['basic structure', 'kesavananda'],
        highYield: true,
      },
      {
        id: 'judiciary',
        ...
        type: 'theme',
        note: 'SC & HC jurisdiction, appointment, independence',
        keywords: ['supreme court', 'high court', 'jurisdiction'],
      },
    ],
  },
  {
    ...
    description:
      'Arrest, bail, FIR, investigation, trial, and appeals under the new BNSS (and legacy CrPC mapping).',
  ...
  },
  {
    ...
    topics: [
      ...
      { id: 'res-judicata', name: 'Res Judicata & Res Sub Judice', type: 'theme', highYield: true, keywords: ['res judicata', 'section 11'] },
  ...
  },
  {
    ...
    description:
      'General principles, offences against body and property, and key BNS sections with IPC mapping.',
    ...
    topics: [
      {
        ...
        name: 'General Explanations & Definitions',
        type: 'chapter',
        note: 'Definitions, common intention, abetment, attempt',
        keywords: ['definitions', 'common intention', 'abetment'],
        highYield: true,
      },
      {
        id: 'general-exceptions',
        name: 'General Exceptions',
        type: 'chapter',
        note: 'Private defence, necessity, insanity, intoxication',
        keywords: ['general exceptions', 'private defence'],
        highYield: true,
      },
      {
        id: 'offences-body',
        ...
        type: 'theme',
        range: 'e.g. homicide, hurt, kidnapping',
        keywords: ['murder', 'culpable homicide', 'hurt', 'kidnapping'],
        highYield: true,
      },
      {
        id: 'culpable-homicide-murder',
        name: 'Culpable Homicide & Murder',
        type: 'section',
        note: 'Classic distinction; high-frequency MCQs',
        keywords: ['murder', 'culpable homicide', 'section 103 bns', 'section 302 ipc'],
        highYield: true,
      },
      {
        id: 'offences-property',
        name: 'Offences against Property',
        type: 'theme',
        keywords: ['theft', 'extortion', 'robbery', 'dacoity', 'cheating'],
        highYield: true,
      },
      {
        id: 'sexual-offences',
        ...
        type: 'theme',
        keywords: ['rape', 'sexual offences'],
      },
      {
        id: 'defamation-misc',
        name: 'Defamation & Miscellaneous',
        type: 'theme',
        keywords: ['defamation'],
      },
      {
        id: 'bns-ipc-map',
        name: 'BNS ↔ IPC Key Mapping',
        type: 'theme',
        note: 'Use BNS–IPC mapper tool for full table',
        keywords: ['mapper', 'ipc', 'bns'],
        highYield: true,
      },
    ],
  },
  ...
  },
  {
    ...
    bareActs: [
      ...
      'Muslim Personal Law (relevant areas)',
  ...
  // ── MEDIUM ──
  {
    ...
    topics: [
      ...
      { id: 'strict-absolute', name: 'Strict & Absolute Liability', type: 'theme', keywords: ['strict liability', 'absolute liability'] },
