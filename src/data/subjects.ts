...
export const SUBJECTS: LawSubjectMeta[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      { id: 'ica-s-2', name: 'ICA s. 2 — Interpretation clause (Proposal, Acceptance, Consideration, Agreement, Contract)', type: 'section', range: 'ICA s. 2', cluster: 'Contract Act', highYield: true, keywords: ['section 2', 'ica 2', 'consideration', 'proposal'] },
      { id: 'ica-s-3-9', name: 'ICA ss. 3–9 — Communication, Acceptance and Revocation of Proposals', type: 'section', range: 'ICA ss. 3–9', cluster: 'Contract Act', keywords: ['communication', 'acceptance', 'revocation'] },
      { id: 'ica-s-10', name: 'ICA s. 10 — What agreements are contracts', type: 'section', range: 'ICA s. 10', cluster: 'Contract Act', highYield: true, keywords: ['section 10', 'ica 10', 'essentials of contract'] },
      { id: 'ica-s-11', name: 'ICA s. 11 — Who are competent to contract (Minor’s agreement, Mohori Bibee)', type: 'section', range: 'ICA s. 11', cluster: 'Contract Act', highYield: true, keywords: ['section 11', 'ica 11', 'minor agreement', 'mohori bibee'] },
      { id: 'ica-s-13-14', name: 'ICA ss. 13 & 14 — Free Consent defined', type: 'section', range: 'ICA ss. 13-14', cluster: 'Contract Act', highYield: true, keywords: ['free consent', 'consensus ad idem'] },
      { id: 'ica-s-15', name: 'ICA s. 15 — Coercion defined', type: 'section', range: 'ICA s. 15', cluster: 'Contract Act', keywords: ['coercion', 'section 15'] },
      { id: 'ica-s-16', name: 'ICA s. 16 — Undue Influence defined', type: 'section', range: 'ICA s. 16', cluster: 'Contract Act', highYield: true, keywords: ['undue influence', 'section 16'] },
      { id: 'ica-s-17', name: 'ICA s. 17 — Fraud defined', type: 'section', range: 'ICA s. 17', cluster: 'Contract Act', highYield: true, keywords: ['fraud', 'section 17'] },
      { id: 'ica-s-18', name: 'ICA s. 18 — Misrepresentation defined', type: 'section', range: 'ICA s. 18', cluster: 'Contract Act', keywords: ['misrepresentation', 'section 18'] },
      { id: 'ica-s-20-22', name: 'ICA ss. 20–22 — Mistake of fact and law', type: 'section', range: 'ICA ss. 20-22', cluster: 'Contract Act', keywords: ['mistake', 'bilateral mistake'] },
      { id: 'ica-s-23', name: 'ICA s. 23 — What consideration and objects are lawful', type: 'section', range: 'ICA s. 23', cluster: 'Contract Act', highYield: true, keywords: ['lawful consideration', 'public policy', 'section 23'] },
      { id: 'ica-s-25', name: 'ICA s. 25 — Agreement without consideration, void (Exceptions)', type: 'section', range: 'ICA s. 25', cluster: 'Contract Act', highYield: true, keywords: ['section 25', 'nudum pactum', 'natural love and affection'] },
      { id: 'ica-s-27', name: 'ICA s. 27 — Agreement in restraint of trade, void', type: 'section', range: 'ICA s. 27', cluster: 'Contract Act', highYield: true, keywords: ['restraint of trade', 'section 27', 'negative covenant'] },
      { id: 'ica-s-28', name: 'ICA s. 28 — Agreements in restraint of legal proceedings, void', type: 'section', range: 'ICA s. 28', cluster: 'Contract Act', keywords: ['restraint of legal proceedings', 'section 28'] },
      { id: 'ica-s-30', name: 'ICA s. 30 — Agreements by way of wager, void', type: 'section', range: 'ICA s. 30', cluster: 'Contract Act', keywords: ['wager', 'section 30'] },
      { id: 'ica-s-31', name: 'ICA s. 31 — Contingent contract defined', type: 'section', range: 'ICA s. 31', cluster: 'Contract Act', keywords: ['contingent contract', 'section 31'] },
      { id: 'ica-s-56', name: 'ICA s. 56 — Agreement to do impossible act (Doctrine of Frustration)', type: 'section', range: 'ICA s. 56', cluster: 'Contract Act', highYield: true, keywords: ['frustration', 'section 56', 'satyabrata ghose'] },
      { id: 'ica-s-62', name: 'ICA s. 62 — Effect of novation, rescission, and alteration of contract', type: 'section', range: 'ICA s. 62', cluster: 'Contract Act', keywords: ['novation', 'section 62', 'alteration'] },
      { id: 'ica-s-68-72', name: 'ICA ss. 68–72 — Quasi-contracts (Certain relations resembling contract)', type: 'section', range: 'ICA ss. 68-72', cluster: 'Contract Act', highYield: true, keywords: ['quasi contract', 'unjust enrichment'] },
      { id: 'ica-s-73', name: 'ICA s. 73 — Compensation for loss or damage caused by breach of contract', type: 'section', range: 'ICA s. 73', cluster: 'Contract Act', highYield: true, keywords: ['section 73', 'damages', 'hadley v baxendale'] },
      { id: 'ica-s-74', name: 'ICA s. 74 — Compensation for breach of contract where penalty stipulated', type: 'section', range: 'ICA s. 74', cluster: 'Contract Act', highYield: true, keywords: ['liquidated damages', 'penalty', 'section 74'] },
      { id: 'ica-s-124', name: 'ICA s. 124 — Contract of indemnity defined', type: 'section', range: 'ICA s. 124', cluster: 'Special Contracts', keywords: ['indemnity', 'section 124'] },
      { id: 'ica-s-126', name: 'ICA s. 126 — Contract of guarantee, surety, principal debtor, and creditor', type: 'section', range: 'ICA s. 126', cluster: 'Special Contracts', highYield: true, keywords: ['guarantee', 'surety', 'section 126'] },
      { id: 'ica-s-148', name: 'ICA s. 148 — Bailment, bailor, and bailee defined', type: 'section', range: 'ICA s. 148', cluster: 'Special Contracts', keywords: ['bailment', 'section 148'] },
      { id: 'ica-s-182', name: 'ICA s. 182 — Agent and principal defined', type: 'section', range: 'ICA s. 182', cluster: 'Special Contracts', keywords: ['agency', 'principal', 'agent'] },
      { id: 'doctrine-privity', name: 'Doctrine of Privity of Contract', type: 'doctrine', note: 'Only parties to a contract can sue; exceptions', keywords: ['privity', 'dunlop v selfridge'], highYield: true },
      { id: 'sra-s-5-6', name: 'SRA ss. 5 & 6 — Recovery of possession of specific immovable property', type: 'section', range: 'SRA ss. 5-6', cluster: 'Specific Relief Act', highYield: true, keywords: ['recovery of possession', 'section 6 sra'] },
      { id: 'sra-s-10', name: 'SRA s. 10 — Specific performance in respect of contracts (Mandatory rule)', type: 'section', range: 'SRA s. 10', cluster: 'Specific Relief Act', highYield: true, keywords: ['specific performance', 'section 10 sra', '2018 amendment'] },
      { id: 'sra-s-14', name: 'SRA s. 14 — Contracts not specifically enforceable', type: 'section', range: 'SRA s. 14', cluster: 'Specific Relief Act', highYield: true, keywords: ['section 14 sra', 'determinable contract'] },
      { id: 'sra-s-16', name: 'SRA s. 16 — Personal bars to relief (Readiness and Willingness)', type: 'section', range: 'SRA s. 16', cluster: 'Specific Relief Act', highYield: true, keywords: ['readiness and willingness', 'section 16 sra'] },
      { id: 'sra-s-20', name: 'SRA s. 20 — Substituted performance of contract', type: 'section', range: 'SRA s. 20', cluster: 'Specific Relief Act', keywords: ['substituted performance', 'section 20 sra'] },
      { id: 'sra-s-34', name: 'SRA s. 34 — Discretion of court as to declaration of status or right', type: 'section', range: 'SRA s. 34', cluster: 'Specific Relief Act', highYield: true, keywords: ['declaratory decree', 'section 34 sra'] },
      { id: 'sra-s-36-42', name: 'SRA ss. 36–42 — Injunctions (Temporary, Perpetual & Mandatory)', type: 'section', range: 'SRA ss. 36-42', cluster: 'Specific Relief Act', highYield: true, keywords: ['perpetual injunction', 'mandatory injunction'] },
      { id: 'tpa-s-5', name: 'TPA s. 5 — Transfer of property defined', type: 'section', range: 'TPA s. 5', cluster: 'Transfer of Property Act', keywords: ['transfer of property', 'section 5 tpa'] },
      { id: 'tpa-s-6', name: 'TPA s. 6 — What may be transferred (Spes successionis exclusion)', type: 'section', range: 'TPA s. 6', cluster: 'Transfer of Property Act', highYield: true, keywords: ['spes successionis', 'section 6 tpa'] },
      { id: 'tpa-s-10', name: 'TPA s. 10 — Condition restraining alienation', type: 'section', range: 'TPA s. 10', cluster: 'Transfer of Property Act', highYield: true, keywords: ['restraint on alienation', 'section 10 tpa'] },
      { id: 'tpa-s-13-14', name: 'TPA ss. 13 & 14 — Transfer for benefit of unborn person & Rule against perpetuity', type: 'section', range: 'TPA ss. 13-14', cluster: 'Transfer of Property Act', highYield: true, keywords: ['unborn person', 'rule against perpetuity'] },
      { id: 'tpa-s-35', name: 'TPA s. 35 — Doctrine of Election', type: 'section', range: 'TPA s. 35', cluster: 'Transfer of Property Act', highYield: true, keywords: ['doctrine of election', 'section 35 tpa', 'cooper v cooper'] },
      { id: 'tpa-s-41', name: 'TPA s. 41 — Transfer by ostensible owner', type: 'section', range: 'TPA s. 41', cluster: 'Transfer of Property Act', highYield: true, keywords: ['ostensible owner', 'section 41 tpa', 'benami'] },
      { id: 'tpa-s-43', name: 'TPA s. 43 — Transfer by unauthorized person (Feeding the grant by estoppel)', type: 'section', range: 'TPA s. 43', cluster: 'Transfer of Property Act', keywords: ['feeding the grant by estoppel', 'section 43 tpa'] },
      { id: 'tpa-s-52', name: 'TPA s. 52 — Transfer of property pending suit (Doctrine of Lis Pendens)', type: 'section', range: 'TPA s. 52', cluster: 'Transfer of Property Act', highYield: true, keywords: ['lis pendens', 'section 52 tpa', 'bellamy v sabine'] },
      { id: 'tpa-s-53', name: 'TPA s. 53 — Fraudulent transfer', type: 'section', range: 'TPA s. 53', cluster: 'Transfer of Property Act', keywords: ['fraudulent transfer', 'section 53 tpa'] },
      { id: 'tpa-s-53a', name: 'TPA s. 53A — Part performance', type: 'section', range: 'TPA s. 53A', cluster: 'Transfer of Property Act', highYield: true, keywords: ['part performance', 'section 53a tpa'] },
      { id: 'tpa-s-54', name: 'TPA s. 54 — Sale defined & Contract for sale', type: 'section', range: 'TPA s. 54', cluster: 'Transfer of Property Act', highYield: true, keywords: ['sale', 'contract for sale', 'section 54 tpa'] },
      { id: 'tpa-s-58', name: 'TPA s. 58 — Mortgages (6 Types of Mortgage defined)', type: 'section', range: 'TPA s. 58', cluster: 'Transfer of Property Act', highYield: true, keywords: ['mortgage', 'section 58 tpa', 'usufructuary mortgage', 'english mortgage'] },
      { id: 'tpa-s-105', name: 'TPA s. 105 — Lease defined', type: 'section', range: 'TPA s. 105', cluster: 'Transfer of Property Act', keywords: ['lease', 'lessor', 'lessee', 'section 105 tpa'] },
      { id: 'tpa-s-122', name: 'TPA s. 122 — Gift defined', type: 'section', range: 'TPA s. 122', cluster: 'Transfer of Property Act', highYield: true, keywords: ['gift', 'donee', 'donor', 'section 122 tpa'] },
      { id: 'ni-s-4-6', name: 'NI Act ss. 4, 5 & 6 — Promissory Note, Bill of Exchange & Cheque defined', type: 'section', range: 'NI ss. 4-6', cluster: 'Negotiable Instruments Act', keywords: ['promissory note', 'bill of exchange', 'cheque'] },
      { id: 'ni-s-13', name: 'NI Act s. 13 — Negotiable Instrument defined', type: 'section', range: 'NI s. 13', cluster: 'Negotiable Instruments Act', keywords: ['negotiable instrument', 'section 13 ni'] },
      { id: 'ni-s-118', name: 'NI Act s. 118 — Presumptions as to negotiable instruments', type: 'section', range: 'NI s. 118', cluster: 'Negotiable Instruments Act', highYield: true, keywords: ['presumptions', 'section 118 ni'] },
      { id: 'ni-s-138', name: 'NI Act s. 138 — Dishonour of cheque for insufficiency of funds', type: 'section', range: 'NI s. 138', cluster: 'Negotiable Instruments Act', highYield: true, keywords: ['cheque bounce', 'section 138 ni', 'statutory notice'] },
      { id: 'ni-s-139', name: 'NI Act s. 139 — Presumption in favour of holder', type: 'section', range: 'NI s. 139', cluster: 'Negotiable Instruments Act', highYield: true, keywords: ['section 139 ni', 'presumption', 'rangappa v mohan'] },
      { id: 'ni-s-141', name: 'NI Act s. 141 — Offences by companies (Vicarious liability of directors)', type: 'section', range: 'NI s. 141', cluster: 'Negotiable Instruments Act', highYield: true, keywords: ['offences by companies', 'section 141 ni', 'director liability'] },
      { id: 'ni-s-142', name: 'NI Act s. 142 — Cognizance of offences (Territorial jurisdiction)', type: 'section', range: 'NI s. 142', cluster: 'Negotiable Instruments Act', highYield: true, keywords: ['cognizance', 'section 142 ni', 'jurisdiction'] },
      { id: 'ni-s-148', name: 'NI Act s. 148 — Power of Appellate Court to order deposit of minimum 20%', type: 'section', range: 'NI s. 148', cluster: 'Negotiable Instruments Act', highYield: true, keywords: ['appellate deposit', 'section 148 ni', 'surinder singh deswal'] },
    ],
  },
  {
    id: 'petition-formats',
