...
export const SUBJECTS: LawSubjectMeta[] = [
  ...
  },
  {
    ...
    topics: [
      ...
      { id: 'arrest', name: 'Arrest & Rights of Arrested', type: 'theme', highYield: true, keywords: ['bail', 'anticipatory bail'] },
  ...
  },
  {
    ...
    topics: [
      ...
      { id: 'burden-proof', name: 'Burden of Proof', type: 'theme', keywords: ['burden of proof'] },
  ...
  },
  {
    ...
    description: 'Hindu, Muslim, and Special Marriage Act — marriage, divorce, maintenance, succession, adoption. Theme notes plus high-yield HMA section pages.',
  ...
  },
  {
    ...
    icon: 'Handshake',
    topics: [
      { id: 'arbitration', name: 'Arbitration Act essentials', type: 'act', highYield: true, keywords: ['arbitration', 'section 8', 'section 34'] },
      { id: 'mediation', name: 'Mediation & Conciliation', type: 'theme', keywords: ['mediation', 'conciliation'] },
