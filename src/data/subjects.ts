...
export const SUBJECTS: LawSubjectMeta[] = [
  ...
  },
  {
    ...
    icon: 'FilePen',
    topics: [
      { id: 'format-writ-petition', name: 'Format 1: Writ Petition under Article 226 / 32', type: 'format', note: 'Skeleton + five writs; Art 32 vs 226', keywords: ['writ petition', 'habeas corpus', 'mandamus'], highYield: true, hasNotes: true },
      { id: 'format-pil', name: 'Format 2: Public Interest Litigation (PIL) Petition', type: 'format', note: 'PIL petition skeleton under Art 32 / 226', keywords: ['pil', 'locus standi'], highYield: true, hasNotes: true },
      { id: 'format-plaint', name: 'Format 3: Civil Plaint under Order VII CPC', type: 'format', note: 'Order VII CPC essentials; Order VII Rule 11', keywords: ['plaint', 'order 7'], highYield: true, hasNotes: true },
      { id: 'format-written-statement', name: 'Format 4: Written Statement under Order VIII CPC', type: 'format', note: 'Order VIII CPC; denial, set-off, counter-claim', keywords: ['written statement', 'order 8'], highYield: true, hasNotes: true },
      { id: 'format-fir', name: 'Format 5: First Information Report (FIR) under Section 173 BNSS', type: 'format', note: 'Essential contents of a First Information Report', keywords: ['fir', 'first information report'], highYield: true, hasNotes: true },
      { id: 'format-bail-application', name: 'Format 6: Regular & Anticipatory Bail Application under Section 480 / 482 BNSS', type: 'format', note: 'Regular and anticipatory bail application skeleton', keywords: ['bail application', 'anticipatory bail'], highYield: true, hasNotes: true },
      { id: 'format-legal-notice-138', name: 'Format 7: Statutory Legal Demand Notice under Section 138 NI Act', type: 'format', note: 'Mandatory 15-day notice for dishonour of cheque', keywords: ['legal notice', 'section 138 ni'], highYield: true, hasNotes: true },
      { id: 'format-execution-petition', name: 'Format 8: Execution Petition under Order XXI Rule 11 CPC', type: 'format', note: 'Execution of money decree and possession decree', keywords: ['execution petition', 'order 21'], highYield: true, hasNotes: true },
    ],
  },
  {
    id: 'tort',
