...
const content: TopicContent = {
  ...
  "sections": [
    {
      ...
      "order": 1,
      "content": [
        "BSA s. 142 regulates examination of witnesses within Examination of witnesses.",
    ...
    },
    {
      ...
      "order": 2,
      "content": [
        "Deconstruct every clause of BSA s. 142; do not replace the enacted rule with a one-line Evidence Act summary.",
        "Read it with BSA s. 141, BSA s. 143. Connected provisions may control foundation, exclusion, presumptions, witnesses or the mode of proof.",
    ...
    },
    {
      ...
      "order": 5,
      "content": [
        "Apply BSA s. 142 at the correct stage of trial or inquiry and identify whether the objection concerns tender, marking, admissibility, proof or final weight.",
  ...
  "examples": [
    {
      ...
      "description": "A party identifies the fact in issue, establishes the statutory relevancy link under s. 142, proves the source and authenticity of the record, and satisfies the applicable documentary or electronic foundation. The Court may receive the material and then assess its weight."
    },
    {
      "id": "bsa-142-ill-2",
  ...
  "hypotheticals": [
    {
      "id": "bsa-142-hypo",
      "title": "Chamber Practice Hypothetical: BSA s. 142",
      ...
      "question": "Whether the material is relevant and admissible under BSA s. 142, and what proof and burden consequences follow.",
      "applicableLaw": "BSA s. 142, connected provisions BSA s. 141, BSA s. 143, ss. 3, 55, 57, 63, 104 and 109 where applicable, and s. 170 savings.",
  ...
  "distinctions": [
    {
      "id": "bsa-142-distinction",
      "title": "BSA s. 142: relevancy, admissibility and proof",
      "left": "BSA s. 142",
      "right": "BSA s. 141, BSA s. 143",
      "rows": [
        {
          "point": "Function",
          "left": "Examination of witnesses",
  ...
  "misconceptions": [
    {
      "id": "bsa-142-trap-1",
      "trap": "Citing only the old Evidence Act number for s. 142.",
      "correction": "Use BSA s. 142 for the current regime and mention the historical number only as concordance or when applying the s. 170 savings rule."
    },
    {
      "id": "bsa-142-trap-2",
  ...
  "cases": [
    {
      ...
      "relevance": "Use where s. 142 concerns electronic records or digital proof; it does not decide the relevancy or admissibility of every non-digital item."
    },
    {
      ...
      "relevance": "Use only for digital evidence issues connected with s. 142; distinguish it from ordinary oral, physical-document or privilege questions."
    },
    {
      ...
      "relevance": "Use where s. 142 concerns circumstantial proof or inference; do not use it as a substitute for a section-specific relevancy rule."
    }
  ],
  "questionsAndAnswers": [
    {
  ...
  "revisionPoints": [
    "BSA s. 142: Examination of witnesses.",
