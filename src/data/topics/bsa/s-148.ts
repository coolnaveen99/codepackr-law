...
const content: TopicContent = {
  ...
  "sections": [
    {
      ...
      "order": 1,
      "content": [
        "BSA s. 148 regulates cross-examination as to previous statements in writing within Examination of witnesses.",
    ...
    },
    {
      ...
      "order": 2,
      "content": [
        "Deconstruct every clause of BSA s. 148; do not replace the enacted rule with a one-line Evidence Act summary.",
        "Read it with BSA s. 147, BSA s. 149. Connected provisions may control foundation, exclusion, presumptions, witnesses or the mode of proof.",
    ...
    },
    {
      ...
      "order": 5,
      "content": [
        "Apply BSA s. 148 at the correct stage of trial or inquiry and identify whether the objection concerns tender, marking, admissibility, proof or final weight.",
  ...
  "examples": [
    {
      ...
      "description": "A party identifies the fact in issue, establishes the statutory relevancy link under s. 148, proves the source and authenticity of the record, and satisfies the applicable documentary or electronic foundation. The Court may receive the material and then assess its weight."
    },
    {
      "id": "bsa-148-ill-2",
  ...
  "hypotheticals": [
    {
      "id": "bsa-148-hypo",
      "title": "Chamber Practice Hypothetical: BSA s. 148",
      ...
      "question": "Whether the material is relevant and admissible under BSA s. 148, and what proof and burden consequences follow.",
      "applicableLaw": "BSA s. 148, connected provisions BSA s. 147, BSA s. 149, ss. 3, 55, 57, 63, 104 and 109 where applicable, and s. 170 savings.",
  ...
  "distinctions": [
    {
      "id": "bsa-148-distinction",
      "title": "BSA s. 148: relevancy, admissibility and proof",
      "left": "BSA s. 148",
      "right": "BSA s. 147, BSA s. 149",
      "rows": [
        {
          "point": "Function",
          "left": "Cross-examination as to previous statements in writing",
  ...
  "misconceptions": [
    {
      "id": "bsa-148-trap-1",
      "trap": "Citing only the old Evidence Act number for s. 148.",
      "correction": "Use BSA s. 148 for the current regime and mention the historical number only as concordance or when applying the s. 170 savings rule."
    },
    {
      "id": "bsa-148-trap-2",
  ...
  "cases": [
    {
      ...
      "relevance": "Use where s. 148 concerns electronic records or digital proof; it does not decide the relevancy or admissibility of every non-digital item."
    },
    {
      ...
      "relevance": "Use only for digital evidence issues connected with s. 148; distinguish it from ordinary oral, physical-document or privilege questions."
    },
    {
      ...
      "relevance": "Use where s. 148 concerns circumstantial proof or inference; do not use it as a substitute for a section-specific relevancy rule."
    }
  ],
  "questionsAndAnswers": [
    {
  ...
  "revisionPoints": [
    "BSA s. 148: Cross-examination as to previous statements in writing.",
