...
const content: TopicContent = {
  ...
  "sections": [
    {
      ...
      "order": 1,
      "content": [
        "BSA s. 31 regulates relevancy of statement as to fact of public nature contained in certain acts or notifications within Relevancy of facts.",
    ...
    },
    {
      ...
      "order": 2,
      "content": [
        "Deconstruct every clause of BSA s. 31; do not replace the enacted rule with a one-line Evidence Act summary.",
        "Read it with BSA s. 30, BSA s. 32. Connected provisions may control foundation, exclusion, presumptions, witnesses or the mode of proof.",
    ...
    },
    {
      ...
      "order": 5,
      "content": [
        "Apply BSA s. 31 at the correct stage of trial or inquiry and identify whether the objection concerns tender, marking, admissibility, proof or final weight.",
  ...
  "examples": [
    {
      ...
      "description": "A party identifies the fact in issue, establishes the statutory relevancy link under s. 31, proves the source and authenticity of the record, and satisfies the applicable documentary or electronic foundation. The Court may receive the material and then assess its weight."
    },
    {
      "id": "bsa-31-ill-2",
  ...
  "hypotheticals": [
    {
      "id": "bsa-31-hypo",
      "title": "Chamber Practice Hypothetical: BSA s. 31",
      ...
      "question": "Whether the material is relevant and admissible under BSA s. 31, and what proof and burden consequences follow.",
      "applicableLaw": "BSA s. 31, connected provisions BSA s. 30, BSA s. 32, ss. 3, 55, 57, 63, 104 and 109 where applicable, and s. 170 savings.",
  ...
  "distinctions": [
    {
      "id": "bsa-31-distinction",
      "title": "BSA s. 31: relevancy, admissibility and proof",
      "left": "BSA s. 31",
      "right": "BSA s. 30, BSA s. 32",
      "rows": [
        {
          "point": "Function",
          "left": "Relevancy of statement as to fact of public nature contained in certain Acts or notifications",
  ...
  "misconceptions": [
    {
      "id": "bsa-31-trap-1",
      "trap": "Citing only the old Evidence Act number for s. 31.",
      "correction": "Use BSA s. 31 for the current regime and mention the historical number only as concordance or when applying the s. 170 savings rule."
    },
    {
      "id": "bsa-31-trap-2",
  ...
  "cases": [
    {
      ...
      "relevance": "Use where s. 31 concerns electronic records or digital proof; it does not decide the relevancy or admissibility of every non-digital item."
    },
    {
      ...
      "relevance": "Use only for digital evidence issues connected with s. 31; distinguish it from ordinary oral, physical-document or privilege questions."
    },
    {
      ...
      "relevance": "Use where s. 31 concerns circumstantial proof or inference; do not use it as a substitute for a section-specific relevancy rule."
    }
  ],
  "questionsAndAnswers": [
    {
  ...
  "revisionPoints": [
    "BSA s. 31: Relevancy of statement as to fact of public nature contained in certain Acts or notifications.",
