...
const content: TopicContent = {
  ...
  "sections": [
    {
      ...
      "order": 1,
      "content": [
        "BSA s. 86 regulates presumption as to electronic records and electronic signatures within Documentary evidence.",
    ...
    },
    {
      ...
      "order": 2,
      "content": [
        "Deconstruct every clause of BSA s. 86; do not replace the enacted rule with a one-line Evidence Act summary.",
        "Read it with BSA s. 85, BSA s. 87. Connected provisions may control foundation, exclusion, presumptions, witnesses or the mode of proof.",
    ...
    },
    {
      ...
      "order": 5,
      "content": [
        "Apply BSA s. 86 at the correct stage of trial or inquiry and identify whether the objection concerns tender, marking, admissibility, proof or final weight.",
  ...
  "examples": [
    {
      ...
      "description": "A party identifies the fact in issue, establishes the statutory relevancy link under s. 86, proves the source and authenticity of the record, and satisfies the applicable documentary or electronic foundation. The Court may receive the material and then assess its weight."
    },
    {
      "id": "bsa-86-ill-2",
  ...
  "hypotheticals": [
    {
      "id": "bsa-86-hypo",
      "title": "Chamber Practice Hypothetical: BSA s. 86",
      ...
      "question": "Whether the material is relevant and admissible under BSA s. 86, and what proof and burden consequences follow.",
      "applicableLaw": "BSA s. 86, connected provisions BSA s. 85, BSA s. 87, ss. 3, 55, 57, 63, 104 and 109 where applicable, and s. 170 savings.",
  ...
  "distinctions": [
    {
      "id": "bsa-86-distinction",
      "title": "BSA s. 86: relevancy, admissibility and proof",
      "left": "BSA s. 86",
      "right": "BSA s. 85, BSA s. 87",
      "rows": [
        {
          "point": "Function",
          "left": "Presumption as to electronic records and electronic signatures",
  ...
  "misconceptions": [
    {
      "id": "bsa-86-trap-1",
      "trap": "Citing only the old Evidence Act number for s. 86.",
      "correction": "Use BSA s. 86 for the current regime and mention the historical number only as concordance or when applying the s. 170 savings rule."
    },
    {
      "id": "bsa-86-trap-2",
  ...
  "cases": [
    {
      ...
      "relevance": "Use where s. 86 concerns electronic records or digital proof; it does not decide the relevancy or admissibility of every non-digital item."
    },
    {
      ...
      "relevance": "Use only for digital evidence issues connected with s. 86; distinguish it from ordinary oral, physical-document or privilege questions."
    },
    {
      ...
      "relevance": "Use where s. 86 concerns circumstantial proof or inference; do not use it as a substitute for a section-specific relevancy rule."
    }
  ],
  "questionsAndAnswers": [
    {
  ...
  "revisionPoints": [
    "BSA s. 86: Presumption as to electronic records and electronic signatures.",
