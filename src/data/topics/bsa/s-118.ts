...
const content: TopicContent = {
  ...
  "sections": [
    {
      ...
      "order": 1,
      "content": [
        "BSA s. 118 regulates presumption as to dowry death within Burden of proof.",
    ...
    },
    {
      ...
      "order": 2,
      "content": [
        "Deconstruct every clause of BSA s. 118; do not replace the enacted rule with a one-line Evidence Act summary.",
        "Read it with BSA s. 117, BSA s. 119. Connected provisions may control foundation, exclusion, presumptions, witnesses or the mode of proof.",
    ...
    },
    {
      ...
      "order": 5,
      "content": [
        "Apply BSA s. 118 at the correct stage of trial or inquiry and identify whether the objection concerns tender, marking, admissibility, proof or final weight.",
  ...
  "examples": [
    {
      ...
      "description": "A party identifies the fact in issue, establishes the statutory relevancy link under s. 118, proves the source and authenticity of the record, and satisfies the applicable documentary or electronic foundation. The Court may receive the material and then assess its weight."
    },
    {
      "id": "bsa-118-ill-2",
  ...
  "hypotheticals": [
    {
      "id": "bsa-118-hypo",
      "title": "Chamber Practice Hypothetical: BSA s. 118",
      ...
      "question": "Whether the material is relevant and admissible under BSA s. 118, and what proof and burden consequences follow.",
      "applicableLaw": "BSA s. 118, connected provisions BSA s. 117, BSA s. 119, ss. 3, 55, 57, 63, 104 and 109 where applicable, and s. 170 savings.",
  ...
  "distinctions": [
    {
      "id": "bsa-118-distinction",
      "title": "BSA s. 118: relevancy, admissibility and proof",
      "left": "BSA s. 118",
      "right": "BSA s. 117, BSA s. 119",
      "rows": [
        {
          "point": "Function",
          "left": "Presumption as to dowry death",
  ...
  "misconceptions": [
    {
      "id": "bsa-118-trap-1",
      "trap": "Citing only the old Evidence Act number for s. 118.",
      "correction": "Use BSA s. 118 for the current regime and mention the historical number only as concordance or when applying the s. 170 savings rule."
    },
    {
      "id": "bsa-118-trap-2",
  ...
  "cases": [
    {
      ...
      "relevance": "Use where s. 118 concerns electronic records or digital proof; it does not decide the relevancy or admissibility of every non-digital item."
    },
    {
      ...
      "relevance": "Use only for digital evidence issues connected with s. 118; distinguish it from ordinary oral, physical-document or privilege questions."
    },
    {
      ...
      "relevance": "Use where s. 118 concerns circumstantial proof or inference; do not use it as a substitute for a section-specific relevancy rule."
    }
  ],
  "questionsAndAnswers": [
    {
  ...
  "revisionPoints": [
    "BSA s. 118: Presumption as to dowry death.",
