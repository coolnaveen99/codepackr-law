...
const content: TopicContent = {
  ...
  "sections": [
    {
      ...
      "order": 1,
      "content": [
        "BSA s. 156 regulates exclusion of evidence to contradict answers to questions testing veracity within Examination of witnesses.",
    ...
    },
    {
      ...
      "order": 2,
      "content": [
        "Deconstruct every clause of BSA s. 156; do not replace the enacted rule with a one-line Evidence Act summary.",
        "Read it with BSA s. 155, BSA s. 157. Connected provisions may control foundation, exclusion, presumptions, witnesses or the mode of proof.",
    ...
    },
    {
      ...
      "order": 5,
      "content": [
        "Apply BSA s. 156 at the correct stage of trial or inquiry and identify whether the objection concerns tender, marking, admissibility, proof or final weight.",
  ...
  "examples": [
    {
      ...
      "description": "A party identifies the fact in issue, establishes the statutory relevancy link under s. 156, proves the source and authenticity of the record, and satisfies the applicable documentary or electronic foundation. The Court may receive the material and then assess its weight."
    },
    {
      "id": "bsa-156-ill-2",
  ...
  "hypotheticals": [
    {
      "id": "bsa-156-hypo",
      "title": "Chamber Practice Hypothetical: BSA s. 156",
      ...
      "question": "Whether the material is relevant and admissible under BSA s. 156, and what proof and burden consequences follow.",
      "applicableLaw": "BSA s. 156, connected provisions BSA s. 155, BSA s. 157, ss. 3, 55, 57, 63, 104 and 109 where applicable, and s. 170 savings.",
  ...
  "distinctions": [
    {
      "id": "bsa-156-distinction",
      "title": "BSA s. 156: relevancy, admissibility and proof",
      "left": "BSA s. 156",
      "right": "BSA s. 155, BSA s. 157",
      "rows": [
        {
          "point": "Function",
          "left": "Exclusion of evidence to contradict answers to questions testing veracity",
  ...
  "misconceptions": [
    {
      "id": "bsa-156-trap-1",
      "trap": "Citing only the old Evidence Act number for s. 156.",
      "correction": "Use BSA s. 156 for the current regime and mention the historical number only as concordance or when applying the s. 170 savings rule."
    },
    {
      "id": "bsa-156-trap-2",
  ...
  "cases": [
    {
      ...
      "relevance": "Use where s. 156 concerns electronic records or digital proof; it does not decide the relevancy or admissibility of every non-digital item."
    },
    {
      ...
      "relevance": "Use only for digital evidence issues connected with s. 156; distinguish it from ordinary oral, physical-document or privilege questions."
    },
    {
      ...
      "relevance": "Use where s. 156 concerns circumstantial proof or inference; do not use it as a substitute for a section-specific relevancy rule."
    }
  ],
  "questionsAndAnswers": [
    {
  ...
  "revisionPoints": [
    "BSA s. 156: Exclusion of evidence to contradict answers to questions testing veracity.",
