...
const content: TopicContent = {
  ...
  "sections": [
    {
      "id": "cpc-s-72-module-1",
      "title": "Provenance, Legislative Objective and Procedural Foundation",
      "order": 1,
      "content": [
        "Section 72 CPC - [Repealed] operates within the Execution — repealed cluster of the Code of Civil Procedure, 1908.",
    ...
    {
      "id": "cpc-s-72-module-2",
      "title": "Textual Anatomy, Conditions and Connected Rules",
      "order": 2,
      "content": [
        "Deconstruct the exact language of Section 72 CPC, including its clauses, provisos, explanations and discretion.",
  ...
  "examples": [
    {
      ...
      "description": "The pleadings and court record establish the stage, jurisdiction, service, limitation and every condition of Section 72 CPC. The Court applies the provision and grants the precise procedural relief sought."
    },
    {
      "id": "cpc-s-72-ill-2",
      "title": "Example 2 - Threshold defect",
      "illustrationType": "fail-scenario",
      "description": "A party invokes Section 72 CPC without pleading the material fact, filing within limitation, proving service or satisfying the jurisdictional condition. The Court identifies the missing foundation and refuses or defers the relief according to the Code."
    }
  ],
  "hypotheticals": [
    {
      "id": "cpc-s-72-hypo",
      "title": "Chamber Practice Hypothetical: Section 72 CPC - [Repealed]",
      "facts": "A party seeks an order under Section 72 CPC in a pending civil suit. The opponent raises objections on jurisdiction, limitation, pleadings, service and the authenticity of an electronic record relied upon in the application.",
      "question": "Whether the application under Section 72 CPC is maintainable and what order should the civil court pass.",
      "applicableLaw": "Code of Civil Procedure, 1908: Section 72 CPC, connected provisions the connected provisions of the CPC; Limitation Act, 1963; BSA ss. 63, 104 and 109 where applicable.",
      ...
      "conclusion": "Section 72 CPC applies only if its procedural conditions and the court's jurisdiction are established. The Court should grant, modify, refuse or defer the application according to the proved record and the governing CPC discretion."
    }
  ],
  "distinctions": [
    {
      "id": "cpc-s-72-distinction",
      "title": "Section 72 CPC - [Repealed] and connected civil procedure",
      "left": "Section 72 CPC",
  ...
  "misconceptions": [
    {
      "id": "cpc-s-72-trap-1",
      "trap": "Quoting Section 72 CPC without identifying the stage, conditions and precise relief.",
