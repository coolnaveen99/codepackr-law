...
const content: TopicContent = {
  ...
  "sections": [
    {
      "id": "cpc-s-68-module-1",
      "title": "Provenance, Legislative Objective and Procedural Foundation",
      "order": 1,
      "content": [
        "Section 68 CPC - Delegation to Collector [Repealed] operates within the Execution — repealed cluster of the Code of Civil Procedure, 1908.",
    ...
    {
      "id": "cpc-s-68-module-2",
      "title": "Textual Anatomy, Conditions and Connected Rules",
      "order": 2,
      "content": [
        "Deconstruct the exact language of Section 68 CPC, including its clauses, provisos, explanations and discretion.",
  ...
  "provisions": [
    {
      ...
      "provisionId": "cpc-s-68",
      "section": "s. 68",
      "title": "Delegation to Collector [Repealed]"
    },
    {
      "actId": "bsa",
  ...
  "examples": [
    {
      ...
      "description": "The pleadings and court record establish the stage, jurisdiction, service, limitation and every condition of Section 68 CPC. The Court applies the provision and grants the precise procedural relief sought."
    },
    {
      "id": "cpc-s-68-ill-2",
      "title": "Example 2 - Threshold defect",
      "illustrationType": "fail-scenario",
      "description": "A party invokes Section 68 CPC without pleading the material fact, filing within limitation, proving service or satisfying the jurisdictional condition. The Court identifies the missing foundation and refuses or defers the relief according to the Code."
    }
  ],
  "hypotheticals": [
    {
      "id": "cpc-s-68-hypo",
      "title": "Chamber Practice Hypothetical: Section 68 CPC - Delegation to Collector [Repealed]",
      "facts": "A party seeks an order under Section 68 CPC in a pending civil suit. The opponent raises objections on jurisdiction, limitation, pleadings, service and the authenticity of an electronic record relied upon in the application.",
      "question": "Whether the application under Section 68 CPC is maintainable and what order should the civil court pass.",
      "applicableLaw": "Code of Civil Procedure, 1908: Section 68 CPC, connected provisions the connected provisions of the CPC; Limitation Act, 1963; BSA ss. 63, 104 and 109 where applicable.",
      ...
      "conclusion": "Section 68 CPC applies only if its procedural conditions and the court's jurisdiction are established. The Court should grant, modify, refuse or defer the application according to the proved record and the governing CPC discretion."
    }
  ],
  "distinctions": [
    {
      "id": "cpc-s-68-distinction",
      "title": "Section 68 CPC - Delegation to Collector [Repealed] and connected civil procedure",
      "left": "Section 68 CPC",
      "right": "the connected provisions of the CPC",
      "rows": [
        {
          "point": "Function",
          "left": "Delegation to Collector [Repealed]",
  ...
  "misconceptions": [
    {
      "id": "cpc-s-68-trap-1",
      "trap": "Quoting Section 68 CPC without identifying the stage, conditions and precise relief.",
