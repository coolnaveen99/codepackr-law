...
const content: TopicContent = {
  ...
  questionsAndAnswers: [
    { id: 'rj-10', draftingCategory: 'brief', question: 'State the conditions of res judicata. How does s. 10 differ?', answer: 'Introduction. s. 11 CPC bars re-trial of a matter heard and finally decided between the same parties by a competent court.\n\nEssentials. Former suit; competent court; same parties or privies; matter directly and substantially in issue; heard and finally decided; Explanations I–VIII.\n\nDistinction. s. 10 stays a pending twin suit. s. 11 bars a decided twin suit.\n\nIllustration. Title lost after trial cannot be sued again.\n\nAuthority. Hope Plantations (1999); Nawab Hussain AIR 1977 SC 1680.\n\nConclusion. Cite s. 11 CPC, 1908.' },
    { id: 'rj-16', draftingCategory: 'submissions', question: 'Explain res judicata and constructive res judicata with a problem.', answer: 'Set out the foundational essentials. Then add Explanation IV: a ground that might and ought to have been made a ground of attack or defence is deemed to have been decided. Apply IRAC to the facts. Distinguish Order II r. 2 (relinquished relief from the same cause of action). Close with ss. 10 and 11 CPC, 1908.' },
  ],
