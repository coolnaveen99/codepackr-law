...
const content: TopicContent = {
  glance: `Section 6 identifies natural guardians but does not create an absolute custody entitlement. The Supreme Court has interpreted 'after him' so that the mother is not automatically excluded while the father is alive.`,
  study: `Section 6 identifies natural guardians but does not create an absolute custody entitlement. The Supreme Court has interpreted 'after him' so that the mother is not automatically excluded while the father is alive.\\n\\nThe provision should be read with its provisos, connected sections and the applicable procedural framework. A complete analysis identifies the legal trigger, proving ingredients, evidence, exceptions, forum and precise relief.`,

  sections: [
    { id: 'hmga-s-6-module-1', title: 'Provenance, Legislative Objective & Doctrinal Foundations', order: 1, content: [`The provision is part of the statutory architecture governing family status, property, adoption, guardianship, succession or maintenance. Its object is implemented through the precise legal conditions stated in the Act. The cited Supreme Court authority provides the controlling doctrinal context: 'After him' in s. 6(a) does not make the mother legally incapable of being a natural guardian during the father's lifetime; the provision must be read consistently with equality and the child's welfare.`] },
    { id: 'hmga-s-6-module-2', title: 'Textual Anatomy, Provisos & Statutory Deconstruction', order: 2, content: [`Read s. 6 with every proviso, exception and cross-reference. Do not replace the enacted conditions with a general statement of family-law fairness. Connected provisions can change the result, including provisions on jurisdiction, proof, maintenance, succession, adoption effects or court permission.`] },
    { id: 'hmga-s-6-module-3', title: 'Mandatory Proving Ingredients & Essential Elements', order: 3, content: [
  ...
  misconceptions: [
    { id: 'hmga-s-6-trap-1', trap: `Treating s. 6 as automatic once a family relationship is shown.`, correction: `The relationship is only the starting point; the statutory ingredients, exceptions and evidence must still be established.` },
    { id: 'hmga-s-6-trap-2', trap: `Assuming a parallel maintenance, custody, succession or matrimonial remedy automatically replaces s. 6.`, correction: `Substantive entitlement and procedural remedy must be analyzed separately. A parallel route may coexist, but it does not rewrite the governing provision.` },
  ],

  cases: [
    { name: `Githa Hariharan v. Reserve Bank of India`, year: 1999, citation: `(1999) 2 SCC 228`, court: 'Supreme Court of India', facts: `The Supreme Court considered a dispute requiring interpretation of the governing family-law provision or closely connected statutory rule.`, issue: `What is the correct legal interpretation and application of the governing statutory rule?`, ratioDecidendi: `'After him' in s. 6(a) does not make the mother legally incapable of being a natural guardian during the father's lifetime; the provision must be read consistently with equality and the child's welfare.`, holding: `'After him' in s. 6(a) does not make the mother legally incapable of being a natural guardian during the father's lifetime; the provision must be read consistently with equality and the child's welfare.`, relevance: `Use this authority for the stated statutory proposition, while matching the case facts and the current statutory text before relying on it.` },
  ],

  questionsAndAnswers: [
    { id: 'hmga-s-6-brief', draftingCategory: 'brief', question: `Prepare a structured case brief and legal problem assessment on HMGA s. 6 — Natural guardians of a Hindu minor.`, answer: `I. ISSUE & JURISDICTIONAL THRESHOLD\\nIdentify the exact statutory question and competent forum.\\n\\nII. GOVERNING RULE\\nApply Hindu Minority and Guardianship Act, 1956 s. 6 and its provisos.\\n\\nIII. APPLICATION\\nTest every ingredient against the evidence and chronology.\\n\\nIV. CONCLUSION\\nState only the statutory consequence supported by the record.`, explanation: 'IRAC-style chamber assessment.' },
    { id: 'hmga-s-6-submissions', draftingCategory: 'submissions', question: `Draft written submissions on HMGA s. 6 — Natural guardians of a Hindu minor covering statute, evidence, precedent and procedure.`, answer: `I. MATERIAL FACTS\\nSet out the legally relevant chronology.\\n\\nII. STATUTORY SCHEME\\nDeconstruct s. 6 and connected provisions.\\n\\nIII. PROVING INGREDIENTS\\nMatch each ingredient to admissible evidence.\\n\\nIV. PRECEDENT\\nApply the cited ratio to the precise issue.\\n\\nV. RELIEF\\nAddress forum, maintainability, limitation where applicable and the precise statutory relief.`, explanation: 'Courtroom written-submissions framework.' },
  ],

  bareActPointers: [`Hindu Minority and Guardianship Act, 1956 s. 6`, 'Family Courts Act, 1984 where applicable', 'Bharatiya Sakshya Adhiniyam, 2023 — electronic evidence where applicable'],
  ...
  revisionPoints: [`s. 6 — identify the trigger and every statutory condition.`, 'Check connected provisos and exceptions.', 'Match each material fact to admissible evidence.', 'Confirm forum and any provision-specific limitation issue.', `Lead authority: Githa Hariharan v. Reserve Bank of India — 'After him' in s. 6(a) does not make the mother legally incapable of being a natural guardian during the father's lifetime; the provision must be read consistently with equality and the child's welfare.`],
  relatedTopics: [],
}
