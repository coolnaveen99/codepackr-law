...
const content: TopicContent = {
  ...
  "sections": [
    ...
    {
      "id": "bnss-303-module-2",
      "title": "Textual Anatomy, Provisos and Connected Provisions",
      "order": 2,
      "content": [
        "Deconstruct every clause of BNSS s. 303; do not replace the provision with a CrPC summary.",
        "Read it with BNSS s. 302, BNSS s. 304. A connected section may define the condition, forum, time limit or remedy without replacing this section.",
        "Use historical concordance only to explain development, never as the current citation."
      ]
    },
    {
      "id": "bnss-303-module-3",
      "title": "Mandatory Procedural Ingredients and Stage Test",
      "order": 3,
      "content": [
        "First ingredient: the proceeding must be at the statutory stage addressed by s. 303.",
    ...
    {
      "id": "bnss-303-module-5",
      "title": "Procedural Roadmap, Forum, Limitation and Transition",
      "order": 5,
      "content": [
        "For proceedings under the post-1 July 2024 regime, cite BNSS s. 303 and verify the First Schedule or special statute where applicable.",
  ...
  "examples": [
    {
      ...
      "description": "A proceeding is at the stage governed by s. 303; the authorised officer or court records each statutory reason, follows the required notice and hearing path, and acts within jurisdiction. The order is tested against the section and its connected provisions."
    },
    {
      "id": "bnss-303-ill-2",
      "title": "Example 2 - Boundary defect",
      "illustrationType": "fail-scenario",
      "description": "The decision-maker applies s. 303 without checking the procedural stage, the s. 531 savings rule or an express statutory condition. The advocate identifies the missing condition and seeks the precise procedural remedy rather than asserting an automatic result unsupported by the Act."
    }
  ],
  "hypotheticals": [
    {
      "id": "bnss-303-hypo",
      "title": "Chamber Practice Hypothetical: BNSS s. 303",
      "facts": "A criminal proceeding is challenged after an order applying BNSS s. 303 to a disputed procedural step. The record contains a disagreement about the commencement status, forum, statutory condition and authenticity of an electronic record.",
      "question": "Whether the order under BNSS s. 303 is sustainable and what immediate relief is available.",
      "applicableLaw": "BNSS s. 303, s. 531, connected provisions BNSS s. 302, BNSS s. 304; BSA ss. 63, 104 and 106; Articles 14, 21 and 22.",
      "analysis": "1. Identify the stage and whether the proceeding was pending immediately before 1 July 2024. 2. State the exact test in s. 303. 3. Verify jurisdiction, notice, reasons, time limits and hearing requirements. 4. Test the electronic record separately under BSA s. 63. 5. Grant only the remedy supported by the proved defect, such as modification, release, disclosure, remand correction, quashing where maintainable or appellate interference.",
  ...
  "distinctions": [
    {
      "id": "bnss-303-distinction",
      "title": "BNSS s. 303 and its connected procedure",
      "left": "BNSS s. 303",
      "right": "BNSS s. 302, BNSS s. 304",
      "rows": [
        {
          "point": "Function",
          "left": "Power of State Government or Central Government to exclude certain persons from operation of section 302",
  ...
  "misconceptions": [
    {
      "id": "bnss-303-trap-1",
      "trap": "Citing only the old CrPC number for s. 303.",
      "correction": "Use BNSS s. 303 for the current regime and mention the historical number only when the transition or comparison requires it."
    },
    {
      "id": "bnss-303-trap-2",
  ...
  "cases": [
    {
      ...
      "relevance": "Use only where s. 303 concerns information, investigation or a connected pre-cognizance step; do not treat this case as authority for every BNSS provision."
    },
    {
      ...
      "relevance": "Use where s. 303 concerns arrest, custody, remand or liberty; otherwise identify a section-specific authority instead of forcing this case into the argument."
    },
    {
      ...
      "relevance": "Use where s. 303 directly engages arrest, custody, production or custody records; do not cite it as a substitute for the statutory text."
    }
  ],
  "questionsAndAnswers": [
    {
  ...
  "examTips": [
    "Begin with the exact current-law citation: BNSS s. 303.",
  ...
  "revisionPoints": [
    "BNSS s. 303: Power of State Government or Central Government to exclude certain persons from operation of section 302.",
