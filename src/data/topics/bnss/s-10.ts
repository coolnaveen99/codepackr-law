...
const content: TopicContent = {
  ...
  "sections": [
    {
      ...
      "order": 1,
      "content": [
        "BNSS s. 10 regulates chief judicial magistrate and additional chief judicial magistrate, etc within Constitution of Criminal Courts and Offices.",
    ...
    },
    {
      ...
      "order": 2,
      "content": [
        "Deconstruct every clause of BNSS s. 10; do not replace the provision with a CrPC summary.",
        "Read it with BNSS s. 9, BNSS s. 11. A connected section may define the condition, forum, time limit or remedy without replacing this section.",
    ...
    },
    {
      ...
      "order": 3,
      "content": [
        "First ingredient: the proceeding must be at the statutory stage addressed by s. 10.",
    ...
    },
    {
      ...
      "order": 5,
      "content": [
        "For proceedings under the post-1 July 2024 regime, cite BNSS s. 10 and verify the First Schedule or special statute where applicable.",
  ...
  "examples": [
    {
      ...
      "description": "A proceeding is at the stage governed by s. 10; the authorised officer or court records each statutory reason, follows the required notice and hearing path, and acts within jurisdiction. The order is tested against the section and its connected provisions."
    },
    {
      "id": "bnss-10-ill-2",
      "title": "Example 2 - Boundary defect",
      "illustrationType": "fail-scenario",
      "description": "The decision-maker applies s. 10 without checking the procedural stage, the s. 531 savings rule or an express statutory condition. The advocate identifies the missing condition and seeks the precise procedural remedy rather than asserting an automatic result unsupported by the Act."
    }
  ],
  "hypotheticals": [
    {
      "id": "bnss-10-hypo",
      "title": "Chamber Practice Hypothetical: BNSS s. 10",
      "facts": "A criminal proceeding is challenged after an order applying BNSS s. 10 to a disputed procedural step. The record contains a disagreement about the commencement status, forum, statutory condition and authenticity of an electronic record.",
      "question": "Whether the order under BNSS s. 10 is sustainable and what immediate relief is available.",
      "applicableLaw": "BNSS s. 10, s. 531, connected provisions BNSS s. 9, BNSS s. 11; BSA ss. 63, 104 and 106; Articles 14, 21 and 22.",
      "analysis": "1. Identify the stage and whether the proceeding was pending immediately before 1 July 2024. 2. State the exact test in s. 10. 3. Verify jurisdiction, notice, reasons, time limits and hearing requirements. 4. Test the electronic record separately under BSA s. 63. 5. Grant only the remedy supported by the proved defect, such as modification, release, disclosure, remand correction, quashing where maintainable or appellate interference.",
  ...
  "distinctions": [
    {
      "id": "bnss-10-distinction",
      "title": "BNSS s. 10 and its connected procedure",
      "left": "BNSS s. 10",
      "right": "BNSS s. 9, BNSS s. 11",
      "rows": [
        {
          "point": "Function",
          "left": "Chief Judicial Magistrate and Additional Chief Judicial Magistrate, etc",
  ...
  "misconceptions": [
    {
      "id": "bnss-10-trap-1",
      "trap": "Citing only the old CrPC number for s. 10.",
      "correction": "Use BNSS s. 10 for the current regime and mention the historical number only when the transition or comparison requires it."
    },
    {
      "id": "bnss-10-trap-2",
  ...
  "cases": [
    {
      ...
      "relevance": "Use only where s. 10 concerns information, investigation or a connected pre-cognizance step; do not treat this case as authority for every BNSS provision."
    },
    {
      ...
      "relevance": "Use where s. 10 concerns arrest, custody, remand or liberty; otherwise identify a section-specific authority instead of forcing this case into the argument."
    },
    {
      ...
      "relevance": "Use where s. 10 directly engages arrest, custody, production or custody records; do not cite it as a substitute for the statutory text."
    }
  ],
  "questionsAndAnswers": [
    {
  ...
  "examTips": [
    "Begin with the exact current-law citation: BNSS s. 10.",
  ...
  "revisionPoints": [
    "BNSS s. 10: Chief Judicial Magistrate and Additional Chief Judicial Magistrate, etc.",
