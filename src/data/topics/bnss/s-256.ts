...
const content: TopicContent = {
  ...
  "sections": [
    ...
    {
      "id": "bnss-256-module-2",
      "title": "Textual Anatomy, Provisos and Connected Provisions",
      "order": 2,
      "content": [
        "Deconstruct every clause of BNSS s. 256; do not replace the provision with a CrPC summary.",
        "Read it with BNSS s. 255, BNSS s. 257. A connected section may define the condition, forum, time limit or remedy without replacing this section.",
        "Use historical concordance only to explain development, never as the current citation."
      ]
    },
    {
      "id": "bnss-256-module-3",
      "title": "Mandatory Procedural Ingredients and Stage Test",
      "order": 3,
      "content": [
        "First ingredient: the proceeding must be at the statutory stage addressed by s. 256.",
    ...
    {
      "id": "bnss-256-module-5",
      "title": "Procedural Roadmap, Forum, Limitation and Transition",
      "order": 5,
      "content": [
        "For proceedings under the post-1 July 2024 regime, cite BNSS s. 256 and verify the First Schedule or special statute where applicable.",
  ...
  "examples": [
    {
      ...
      "description": "A proceeding is at the stage governed by s. 256; the authorised officer or court records each statutory reason, follows the required notice and hearing path, and acts within jurisdiction. The order is tested against the section and its connected provisions."
    },
    {
      "id": "bnss-256-ill-2",
      "title": "Example 2 - Boundary defect",
      "illustrationType": "fail-scenario",
      "description": "The decision-maker applies s. 256 without checking the procedural stage, the s. 531 savings rule or an express statutory condition. The advocate identifies the missing condition and seeks the precise procedural remedy rather than asserting an automatic result unsupported by the Act."
    }
  ],
  "hypotheticals": [
    {
      "id": "bnss-256-hypo",
      "title": "Chamber Practice Hypothetical: BNSS s. 256",
      "facts": "A criminal proceeding is challenged after an order applying BNSS s. 256 to a disputed procedural step. The record contains a disagreement about the commencement status, forum, statutory condition and authenticity of an electronic record.",
      "question": "Whether the order under BNSS s. 256 is sustainable and what immediate relief is available.",
      "applicableLaw": "BNSS s. 256, s. 531, connected provisions BNSS s. 255, BNSS s. 257; BSA ss. 63, 104 and 106; Articles 14, 21 and 22.",
      "analysis": "1. Identify the stage and whether the proceeding was pending immediately before 1 July 2024. 2. State the exact test in s. 256. 3. Verify jurisdiction, notice, reasons, time limits and hearing requirements. 4. Test the electronic record separately under BSA s. 63. 5. Grant only the remedy supported by the proved defect, such as modification, release, disclosure, remand correction, quashing where maintainable or appellate interference.",
  ...
  "distinctions": [
    {
      "id": "bnss-256-distinction",
      "title": "BNSS s. 256 and its connected procedure",
      "left": "BNSS s. 256",
      "right": "BNSS s. 255, BNSS s. 257",
      "rows": [
        {
          "point": "Function",
          "left": "Entering upon defence",
  ...
  "misconceptions": [
    {
      "id": "bnss-256-trap-1",
      "trap": "Citing only the old CrPC number for s. 256.",
      "correction": "Use BNSS s. 256 for the current regime and mention the historical number only when the transition or comparison requires it."
    },
    {
      "id": "bnss-256-trap-2",
  ...
  "cases": [
    {
      ...
      "relevance": "Use only where s. 256 concerns information, investigation or a connected pre-cognizance step; do not treat this case as authority for every BNSS provision."
    },
    {
      ...
      "relevance": "Use where s. 256 concerns arrest, custody, remand or liberty; otherwise identify a section-specific authority instead of forcing this case into the argument."
    },
    {
      ...
      "relevance": "Use where s. 256 directly engages arrest, custody, production or custody records; do not cite it as a substitute for the statutory text."
    }
  ],
  "questionsAndAnswers": [
    {
  ...
  "examTips": [
    "Begin with the exact current-law citation: BNSS s. 256.",
  ...
  "revisionPoints": [
    "BNSS s. 256: Entering upon defence.",
