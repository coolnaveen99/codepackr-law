...
const content: TopicContent = {
  glance:
    'Part IV (Articles 36–51) embodies the Directive Principles of State Policy (DPSP), establishing India’s vision of a socio-economic welfare state. While non-justiciable under Article 37, they are fundamental in the governance of the country. Minerva Mills (1980) settled that the balance between Part III and Part IV is an inviolable feature of the Basic Structure.',

  study: `Topic at a Glance
Part IV of the Constitution of India (Articles 36–51) sets out the Directive Principles of State Policy (DPSP). Borrowed from the Constitution of Ireland (which adapted them from Spanish constitutionalism), the DPSPs constitute the socio-economic manifesto of the Indian Republic. Dr. B.R. Ambedkar described them as a “novel feature” designed to transform India from a mere political democracy into an authentic economic democracy.

Constitutional Status & Enforceability: Article 37
Article 37 establishes the dual nature of Directive Principles:
1. Negative Limb (Non-Justiciability): “The provisions contained in this Part shall not be enforceable by any court.” No court can issue a writ of mandamus to compel Parliament or a State Legislature to enact or fund a Directive Principle (State of Madras v. Champakam Dorairajan).
2. Positive Limb (Fundamental in Governance): “...but the principles therein laid down are nevertheless fundamental in the governance of the country and it shall be the duty of the State to apply these principles in making laws.”

Classification of Directive Principles
Although the text does not contain formal ideological headings, constitutional scholars and courts classify DPSPs into three broad categories:
1. Socialistic Principles:
   - Article 38: Promoting welfare of people by securing a social order permeated by social, economic, and political justice, and minimizing inequalities in income, status, and facilities.
   - Article 39: Principles of policy to be followed by the State:
     (a) Adequate means of livelihood for all citizens;
     (b) Distribution of ownership and control of material resources to subserve the common good;
     ...
     (e) Health and strength of workers and tender age of children not abused;
     (f) Children given opportunities to develop in a healthy manner and protected from exploitation.
   - Article 39A: Equal justice and free legal aid (inserted by 42nd Amendment, 1976).
   - Article 41: Right to work, to education, and to public assistance in cases of unemployment, old age, and sickness.
   - Article 42: Just and humane conditions of work and maternity relief.
   - Article 43: Living wage, decent standard of life, and promotion of cottage industries.
   - Article 43A: Workers’ participation in management of industries (42nd Amendment, 1976).
2. Gandhian Principles:
   - Article 40: Organization of village panchayats as units of self-government (culminated in 73rd Amendment, 1992).
   - Article 43B: Promotion of voluntary, autonomous, and democratic co-operative societies (97th Amendment, 2011).
   - Article 46: Promotion of educational and economic interests of SCs, STs, and weaker sections.
   - Article 47: Duty to raise nutrition and public health, and bring about prohibition of intoxicating drinks and injurious drugs.
   - Article 48: Organization of agriculture and animal husbandry, and prohibiting the slaughter of cows, calves, and milch cattle.
3. Liberal-Intellectual Principles:
   - Article 44: Uniform Civil Code for all citizens throughout India.
   - Article 45: Early childhood care and education for children below six years (recast by 86th Amendment, 2002).
   - Article 48A: Protection and improvement of environment and safeguarding of forests and wildlife (42nd Amendment, 1976).
   - Article 49: Protection of monuments, historic places, and national objects.
   - Article 50: Separation of the judiciary from the executive in public services.
   - Article 51: Promotion of international peace, security, and respect for treaty obligations.

The Historic Judicial Battle: Part III vs Part IV
The relationship between Fundamental Rights and Directive Principles witnessed a profound judicial evolution across four phases:
1. Phase 1 — Subordination of DPSPs (State of Madras v. Champakam Dorairajan, 1951):
...
5. Phase 5 — Modern Symbiosis & Integration (The Integrated Human Rights Doctrine):
   ...
   - Article 39(d) (Equal Pay for Equal Work) enforced through Article 14 (Randhir Singh).
   - Article 45 (Education) elevated into Article 21A by constitutional amendment.

Procedural & Courtroom Anchors (Senior Counsel Checklist)
1. Defense of Statutory Validity:
   Where a state welfare statute or tax classification is challenged under Article 14 or 19, government counsel must cite Part IV (e.g. Art 39(b)/(c), Art 46). If a law is enacted to implement a DPSP, it provides strong justification that the restriction is "reasonable" and in the "public interest" (State of Bombay v. F.N. Balsara; Pathumma v. State of Kerala).
2. Non-Justiciability Bar:
...
Directive Principles operate as the socio-economic compass of the Republic. The enactment of the Right to Education Act (Article 21A), the National Food Security Act, MGNREGA, and state UCC legislation (Uttarakhand, 2024) demonstrate the continuous statutory codification of Part IV. Current through the 106th Amendment (2023).`,
  ...
  provisions: [
    ...
    { actId: 'constitution', actName: 'Constitution of India', provisionId: 'constitution-article-44', article: 'Article 44', title: 'Uniform civil code for the citizens' },
  ],

  examples: [
    {
      id: 'dpsp-ex-1',
      title: 'Illustration 1 — DPSP Validating Statutory Restriction (Upheld)',
      description: 'The State enacts a statute fixing minimum wages for agricultural labourers and restricting employers from paying below the statutory threshold. Employers challenge the law under Article 19(1)(g) as restricting their freedom of trade. The Supreme Court holds that the statute gives effect to Article 43 (living wage) and therefore constitutes a reasonable restriction in the interest of the general public under Article 19(6) (Bijay Cotton Mills v. State of Ajmer).',
    },
    {
      id: 'dpsp-ex-2',
      title: 'Illustration 2 — Inadmissibility of Mandamus (Article 37 Bar)',
      description: 'A petitioner files a writ petition under Article 32 demanding a writ of mandamus commanding the Union of India to immediately enact a Uniform Civil Code under Article 44. The Supreme Court dismisses the writ petition, holding that under Article 37, Directive Principles are non-justiciable; the judiciary cannot usurp legislative functions by commanding the legislature to enact a specific law (Maharshi Avadhesh v. Union of India).',
    },
  ],
  ...
  hypotheticals: [
    {
      ...
      analysis: '1. The Minerva Mills Principle: The Indian Constitution is founded on the balance between Part III and Part IV. Parliament cannot confer absolute primacy on Directive Principles over Fundamental Rights so as to completely destroy Part III rights.\n2. Scope of Article 31C: While laws giving effect to Article 39(b) and (c) enjoy limited protection, an absolute ouster of judicial review or total abrogation of the Golden Triangle (Articles 14, 19, 21) violates the Basic Structure.\n3. Procedural Fairness: Total denial of pre-decisional hearing and arbitrary deprivation without determining principles violates the non-arbitrariness guarantee of Article 14 and procedural fairness under Article 21.\n4. Harmonious Construction: The State must implement socio-economic reforms without obliterating core civil liberties.',
      conclusion: 'The clause ousting judicial review and extinguishing fundamental rights is unconstitutional under Minerva Mills. The statute must be read down to conform to procedural fairness and reasonable compensation.',
    },
  ],

  distinctions: [
    {
      id: 'dpsp-part3-v-part4',
      title: 'Fundamental Rights (Part III) vs Directive Principles (Part IV)',
  ...
  misconceptions: [
    {
      id: 'dpsp-trap-1',
      trap: 'Directive Principles are non-enforceable and therefore legally useless.',
      correction: 'Under Article 37, DPSPs are fundamental in governance. They serve as an interpretative compass, justify reasonable restrictions under Article 19, and have been read directly into Article 21.',
    },
    {
      id: 'dpsp-trap-2',
  ...
  examFrameworks: [
    {
      ...
      steps: [
        ...
        'Article 37 deconstruction: Non-justiciable vs fundamental in governance.',
        'Classify principles into Socialistic, Gandhian, and Liberal-Intellectual with key articles.',
        'Explain their role in testing the reasonableness of statutory restrictions under Art 19.',
    ...
    },
    {
      ...
      steps: [
        ...
        'Trace the early subordination view in Champakam Dorairajan (1951).',
        'Analyze the doctrine of harmonious construction in Kerala Education Bill (1958).',
        'Examine the Article 31C controversy and the 25th / 42nd Amendments.',
        'Detailed analysis of Minerva Mills (1980) and the Basic Structure balance.',
        'Modern integration: Reading DPSPs into Article 21 (Hoskot, M.C. Mehta, Unni Krishnan).',
