...
const content: TopicContent = {
  glance: 'BNS Section 160: Abetment of mutiny, if mutiny is committed in consequence thereof. Aggravated abetment where mutiny is actually committed in consequence of the abetment; causal connection between the abetment and mutiny matters. The note treats the enacted BNS text as controlling for post-1 July 2024 conduct and uses IPC s. 132 only as historical concordance.',
  study: `Section 160 — Abetment of mutiny, if mutiny is committed in consequence thereof.\\n\\nAggravated abetment where mutiny is actually committed in consequence of the abetment; causal connection between the abetment and mutiny matters.\\n\\nHistorical IPC concordance: 132. Read the enacted BNS wording, including every explanation, proviso and exception. For conduct before 1 July 2024, separately apply the repeal-and-savings framework and Article 20(1).`,
  sections:[
    {id:'s-160-m1',title:'Provenance, Legislative Objective & Doctrinal Foundations',order:1,content:[
      'Chapter: Armed forces.',
      'Aggravated abetment where mutiny is actually committed in consequence of the abetment; causal connection between the abetment and mutiny matters.',
      'Historical IPC concordance: 132. The concordance is useful for tracing continuity and identifying possible changes, but it is not the governing post-commencement text.',
    ...
    {id:'s-160-m2',title:'Textual Anatomy, Conditions & Statutory Limits',order:2,content:[
      'Operative provision: BNS s. 160 — Abetment of mutiny, if mutiny is committed in consequence thereof.',
      ...
      'For s. 160, the historical IPC concordance is s. 132; use it to orient research only and verify the BNS wording before drafting a charge, opinion or submission.',
    ...
    {id:'s-160-m3',title:'Mandatory Proving Ingredients & Essential Elements',order:3,content:[
      '1. There is abetment of mutiny.','2. Mutiny is actually committed.','3. The mutiny is committed in consequence of the abetment, establishing the required causal link.',
      ...
      'Check connected BNS provisions before concluding that the conduct belongs under s. 160; a more specific provision, definition or exception may control the analysis.'
    ]},
    {id:'s-160-m4',title:'Evidentiary Burdens & BSA 2023 Interface',order:4,content:[
    ...
    {id:'s-160-m5',title:'Procedural Roadmap, Forum & Limitation Checkpoints',order:5,content:[
  ...
  provisions:[{actId:'bns',actName:'Bharatiya Nyaya Sanhita, 2023',provisionId:'bns-160',section:'s. 160',title:'Abetment of mutiny, if mutiny is committed in consequence thereof'}],
  examples:[
    {id:'s-160-ex1',title:'Statutory ingredients satisfied',illustrationType:'practical',description:'The proved facts establish each material ingredient of BNS s. 160, including the relevant status, act, circumstance and mental element, and no applicable exception defeats the charge.'},
    {id:'s-160-ex2',title:'Ingredient or qualification missing',illustrationType:'fail-scenario',description:'The conduct resembles the provision, but one required statutory ingredient, status, mental element, causal link or evidentiary foundation is not established.'}
  ],
  hypotheticals:[{id:'s-160-hypo',title:'Chamber problem — BNS s. 160',facts:'The prosecution invokes BNS s. 160 on a fact pattern involving abetment of mutiny, if mutiny is committed in consequence thereof. The defence disputes one or more ingredients and challenges the evidentiary link.',question:'Do the proved facts satisfy BNS s. 160?',applicableLaw:'BNS s. 160; connected BNS provisions and definitions; applicable BNSS procedure; BSA 2023 evidence rules.',analysis:'1. Identify the exact enacted words. 2. Break them into ingredients and qualifiers. 3. Establish any protected status or factual precondition. 4. Map admissible evidence to each ingredient. 5. Apply exceptions, defences and connected provisions. 6. Check BNSS classification and procedural preconditions.',conclusion:'The conclusion must follow from the enacted statutory ingredients and proved facts, not from the historical IPC number or the section heading alone.'}],
  distinctions:[{id:'s-160-dist',title:'BNS provision vs historical IPC concordance',left:'BNS s. 160',right:'Historical IPC s. 132',rows:[
  ...
  misconceptions:[
    {id:'s-160-trap',trap:'The historical IPC section can simply be substituted for BNS s. 160.',correction:'The enacted BNS text governs post-commencement offences; IPC s. 132 is historical concordance only.'},
    {id:'s-160-trap-2',trap:'A matching label or suspicious fact pattern is enough to establish the offence.',correction:'Every material ingredient, statutory qualification and applicable exception must be established on the evidence.'},
    {id:'s-160-trap-3',trap:'Procedure, evidence and the substantive offence can be analyzed separately without cross-checking.',correction:'A defensible assessment links the BNS ingredients with BNSS procedure and BSA proof requirements.'}
  ],
  cases:[],
  questionsAndAnswers:[
    {id:'s-160-brief',draftingCategory:'brief',question:'Prepare a structured legal assessment of BNS s. 160.',answer:`I. ISSUE — identify the precise statutory question.\\nII. RULE — reproduce the governing BNS ingredients, definitions, exceptions and connected provisions.\\nIII. EVIDENCE — identify admissible proof for each ingredient and the applicable burden.\\nIV. PROCEDURE — check BNSS classification, forum and statutory preconditions.\\nV. APPLICATION — map the proved facts to each element.\\nVI. CONCLUSION — state only the consequence supported by the proved record.`,explanation:'Chamber-style structured analysis without unverified authorities.'},
    {id:'s-160-submissions',draftingCategory:'submissions',question:'Draft written submissions on BNS s. 160.',answer:`I. STATUTORY SCHEME.\\nII. INGREDIENTS AND QUALIFICATIONS.\\nIII. EVIDENCE AND BURDEN.\\nIV. RESPONSE TO DEFENCE / EXCEPTION.\\nV. PROCEDURAL POSITION.\\nVI. RELIEF OR OPERATIVE CONSEQUENCE.`,explanation:'Courtroom submission structure without unverified case citations.'},
    {id:'s-160-qa',draftingCategory:'qa',question:'What is the safest way to distinguish BNS s. 160 from its IPC concordance?',answer:'Quote and analyze the enacted BNS wording first; use IPC s. 132 only to explain historical continuity or change, and separately verify the current BNSS and BSA interfaces.',explanation:'This prevents historical concordance from becoming an unintended substitute for the current statute.'}
  ],
  bareActPointers:['BNS s. 160 — Abetment of mutiny, if mutiny is committed in consequence thereof; BNS Chapter VIII; historical IPC concordance s. 132; connected definitions and neighbouring provisions in the same chapter; BNSS First Schedule and applicable procedure; BSA 2023 provisions on burden, admissions, documentary/electronic proof where relevant; BNS repeal-and-savings framework for pre-1 July 2024 conduct.'],
  ...
  revisionPoints:['BNS s. 160: Abetment of mutiny, if mutiny is committed in consequence thereof.','Cluster: Armed forces.','Historical IPC concordance: 132.','Key analytical focus: Aggravated abetment where mutiny is actually committed in consequence of the abetment; causal connection between the abetment and mutiny matters..','Verify current procedural and evidentiary requirements before relying on the note in a live matter.'],
  relatedTopics:["159","161"]
}
