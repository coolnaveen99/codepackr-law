...
const content: TopicContent = {
  glance: 'BNS Section 168: Wearing garb or carrying token used by soldier, sailor or airman. Wearing military garb or carrying a token associated with a soldier, sailor or airman with the statutory intention or circumstances required by the provision. The note treats the enacted BNS text as controlling for post-1 July 2024 conduct and uses IPC s. 140 only as historical concordance.',
  study: `Section 168 — Wearing garb or carrying token used by soldier, sailor or airman.\\n\\nWearing military garb or carrying a token associated with a soldier, sailor or airman with the statutory intention or circumstances required by the provision.\\n\\nHistorical IPC concordance: 140. Read the enacted BNS wording, including every explanation, proviso and exception. For conduct before 1 July 2024, separately apply the repeal-and-savings framework and Article 20(1).`,
  sections:[
    {id:'s-168-m1',title:'Provenance, Legislative Objective & Doctrinal Foundations',order:1,content:[
      'Chapter: Armed forces.',
      'Wearing military garb or carrying a token associated with a soldier, sailor or airman with the statutory intention or circumstances required by the provision.',
      'Historical IPC concordance: 140. The concordance is useful for tracing continuity and identifying possible changes, but it is not the governing post-commencement text.',
    ...
    {id:'s-168-m2',title:'Textual Anatomy, Conditions & Statutory Limits',order:2,content:[
      'Operative provision: BNS s. 168 — Wearing garb or carrying token used by soldier, sailor or airman.',
      ...
      'For s. 168, the historical IPC concordance is s. 140; use it to orient research only and verify the BNS wording before drafting a charge, opinion or submission.',
    ...
    {id:'s-168-m3',title:'Mandatory Proving Ingredients & Essential Elements',order:3,content:[
      '1. The accused wears the specified garb or carries the specified token.','2. The garb/token is of the kind covered by the provision.','3. The statutory intention, knowledge or circumstance is proved.',
      ...
      'Check connected BNS provisions before concluding that the conduct belongs under s. 168; a more specific provision, definition or exception may control the analysis.'
    ]},
    {id:'s-168-m4',title:'Evidentiary Burdens & BSA 2023 Interface',order:4,content:[
    ...
    {id:'s-168-m5',title:'Procedural Roadmap, Forum & Limitation Checkpoints',order:5,content:[
  ...
  provisions:[{actId:'bns',actName:'Bharatiya Nyaya Sanhita, 2023',provisionId:'bns-168',section:'s. 168',title:'Wearing garb or carrying token used by soldier, sailor or airman'}],
  examples:[
    {id:'s-168-ex1',title:'Statutory ingredients satisfied',illustrationType:'practical',description:'The proved facts establish each material ingredient of BNS s. 168, including the relevant status, act, circumstance and mental element, and no applicable exception defeats the charge.'},
    {id:'s-168-ex2',title:'Ingredient or qualification missing',illustrationType:'fail-scenario',description:'The conduct resembles the provision, but one required statutory ingredient, status, mental element, causal link or evidentiary foundation is not established.'}
  ],
  hypotheticals:[{id:'s-168-hypo',title:'Chamber problem — BNS s. 168',facts:'The prosecution invokes BNS s. 168 on a fact pattern involving wearing garb or carrying token used by soldier, sailor or airman. The defence disputes one or more ingredients and challenges the evidentiary link.',question:'Do the proved facts satisfy BNS s. 168?',applicableLaw:'BNS s. 168; connected BNS provisions and definitions; applicable BNSS procedure; BSA 2023 evidence rules.',analysis:'1. Identify the exact enacted words. 2. Break them into ingredients and qualifiers. 3. Establish any protected status or factual precondition. 4. Map admissible evidence to each ingredient. 5. Apply exceptions, defences and connected provisions. 6. Check BNSS classification and procedural preconditions.',conclusion:'The conclusion must follow from the enacted statutory ingredients and proved facts, not from the historical IPC number or the section heading alone.'}],
  distinctions:[{id:'s-168-dist',title:'BNS provision vs historical IPC concordance',left:'BNS s. 168',right:'Historical IPC s. 140',rows:[
  ...
  misconceptions:[
    {id:'s-168-trap',trap:'The historical IPC section can simply be substituted for BNS s. 168.',correction:'The enacted BNS text governs post-commencement offences; IPC s. 140 is historical concordance only.'},
    {id:'s-168-trap-2',trap:'A matching label or suspicious fact pattern is enough to establish the offence.',correction:'Every material ingredient, statutory qualification and applicable exception must be established on the evidence.'},
    {id:'s-168-trap-3',trap:'Procedure, evidence and the substantive offence can be analyzed separately without cross-checking.',correction:'A defensible assessment links the BNS ingredients with BNSS procedure and BSA proof requirements.'}
  ],
  cases:[],
  questionsAndAnswers:[
    {id:'s-168-brief',draftingCategory:'brief',question:'Prepare a structured legal assessment of BNS s. 168.',answer:`I. ISSUE — identify the precise statutory question.\\nII. RULE — reproduce the governing BNS ingredients, definitions, exceptions and connected provisions.\\nIII. EVIDENCE — identify admissible proof for each ingredient and the applicable burden.\\nIV. PROCEDURE — check BNSS classification, forum and statutory preconditions.\\nV. APPLICATION — map the proved facts to each element.\\nVI. CONCLUSION — state only the consequence supported by the proved record.`,explanation:'Chamber-style structured analysis without unverified authorities.'},
    {id:'s-168-submissions',draftingCategory:'submissions',question:'Draft written submissions on BNS s. 168.',answer:`I. STATUTORY SCHEME.\\nII. INGREDIENTS AND QUALIFICATIONS.\\nIII. EVIDENCE AND BURDEN.\\nIV. RESPONSE TO DEFENCE / EXCEPTION.\\nV. PROCEDURAL POSITION.\\nVI. RELIEF OR OPERATIVE CONSEQUENCE.`,explanation:'Courtroom submission structure without unverified case citations.'},
    {id:'s-168-qa',draftingCategory:'qa',question:'What is the safest way to distinguish BNS s. 168 from its IPC concordance?',answer:'Quote and analyze the enacted BNS wording first; use IPC s. 140 only to explain historical continuity or change, and separately verify the current BNSS and BSA interfaces.',explanation:'This prevents historical concordance from becoming an unintended substitute for the current statute.'}
  ],
  bareActPointers:['BNS s. 168 — Wearing garb or carrying token used by soldier, sailor or airman; BNS Chapter VIII; historical IPC concordance s. 140; connected definitions and neighbouring provisions in the same chapter; BNSS First Schedule and applicable procedure; BSA 2023 provisions on burden, admissions, documentary/electronic proof where relevant; BNS repeal-and-savings framework for pre-1 July 2024 conduct.'],
  ...
  revisionPoints:['BNS s. 168: Wearing garb or carrying token used by soldier, sailor or airman.','Cluster: Armed forces.','Historical IPC concordance: 140.','Key analytical focus: Wearing military garb or carrying a token associated with a soldier, sailor or airman with the statutory intention or circumstances required by the provision..','Verify current procedural and evidentiary requirements before relying on the note in a live matter.'],
  relatedTopics:["167"]
}
