# CodePackr Law — Master AI Prompt for Topic Authoring & Updates

> **How to use this file:**
> 1. Copy the entire prompt from the **Copy-Paste Block** below.
> 2. Fill in the 3 bracketed variables:
...
- Target File Location: src/data/topics/[SUBJECT_SLUG]/[TOPIC_ID].ts
...
3. DUAL STATUTORY ILLUSTRATIONS:
   ...
   - Illustration 2 (Boundary Defect / Exception Fails): Factual matrix where one essential ingredient is missing or a statutory exception applies, demonstrating why the claim or prosecution fails.
