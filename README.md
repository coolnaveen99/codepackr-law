...
- **Key High-Yield Anchors**:
  - **Sections**: s. 2 (Definitions — Decree, Order, Judgment, Mesne Profits, Legal Representative), s. 9 (Courts to try civil suits), s. 10 (Res Sub Judice), s. 11 (Res Judicata & Constructive RJ), ss. 15–20 (Place of Suing), ss. 26–35 (Institution, Interest, Costs), s. 32 (Penalty for default — benchmark treatise), ss. 51–74 (Execution), ss. 79–82 (Suits by/against Government), ss. 96–100 (Appeals), ss. 113–115 (Reference, Review, Revision), s. 148A (Caveat), s. 151 (Inherent Powers).
  - **Orders**: Order I (Parties), Order II (Frame of Suit), Order V (Summons), Orders VI–VIII (Pleadings, Plaint, Written Statement, Counter-claim), Order IX (Appearance & Ex-Parte), Order XI/XIII (Discovery & Documents), Order XIV (Settlement of Issues), Order XX (Judgment & Decree), Order XXI (Execution), Order XXII (Abatement), Order XXIII (Compromise), Order XXXVII (Summary Suits), Order XXXVIII (Attachment before Judgment), Order XXXIX (Temporary Injunctions & Triple Test), Order XLI–XLVII (Appeals, Review, Revision).

### 2. Constitutional Law of India — 10 AIBE Questions
- **523 Total Topics**: All 395 Articles (through 106th Amendment, 2023 — *Nari Shakti Vandan Adhiniyam*), Preamble, and core constitutional doctrines.
...
- **368 Total Topics**: All 358 Sections across 20 Chapters with IPC concordance, transitional rules, and sentencing changes.
- **Key High-Yield Anchors**:
  - **Early Chapters**: ss. 1–3 (Preliminary & Definitions; s. 3(5) Common Intention = IPC 34), ss. 4–13 (Punishments including Community Service), ss. 14–44 (General Exceptions, Insanity s. 22, Private Defence ss. 34–44).
  - **Inchoate Crimes**: ss. 45–62 (Abetment, Conspiracy, Attempt).
  - **Offences against Women & Children**: ss. 63–99 (Rape, Consent, s. 69 Deceitful Promise of Marriage, Cruelty, Dowry Death).
  - **Offences against Body & Property**: ss. 100–106 (Culpable Homicide & Murder s. 103), s. 111 (Organised Crime), s. 303 (Theft), s. 304 (Snatching), s. 309 (Robbery).

### 5. Evidence: Bharatiya Sakshya Adhiniyam, 2023 (BSA) — 8 AIBE Questions
- **177 Total Topics**: All 170 Sections across 12 Chapters with Evidence Act 1872 concordance.
- **Key High-Yield Anchors**: s. 4 (Res Gestae), ss. 15–24 (Admissions & Confessions to Police), s. 32 (Dying Declarations & Statements), ss. 57–63 (Primary, Secondary & Section 63 Electronic Records Certificate), ss. 104–106 (Evidentiary Burdens & Special Knowledge), s. 116 (Estoppel).
...
| Item | Value |
|------|-------|
| Accent color | Seal Burgundy `#8B1E3F` / `#9F2D4A` (Tailwind `blue-*` remapped) |
| Header title | **CodePackr Law** |
| Tagline | *Digital Law Library & Practice Reference* |
| Backlink | `← Codepackr Dev Suite` → [codepackr.com](https://www.codepackr.com) |
| Sibling products | [codepackr.com](https://www.codepackr.com) (Dev Blue) · [finance.codepackr.com](https://finance.codepackr.com) (Finance Emerald) |
...
npm run checklist    # Synchronize docs/subject-coverage-checklist.md
npm run audit        # Print subject coverage percentage audit
