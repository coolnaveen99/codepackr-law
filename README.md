...
- **Reusable Legal Knowledge** (`/knowledge`): Canonical doctrines, concepts, maxims, definitions and procedures (Basic Structure, golden triangle, common intention, audi alteram partem, …). Constitution and BNS pages reuse these records instead of duplicating them.
...
### 6. Bharatiya Nyaya Sanhita, 2023 (through 1 July 2024)
- **Section-wise lessons** under Subjects → BNS / IPC: all **358 sections** in 20 chapters, with IPC concordance, exam flags, and related knowledge.
- Dedicated Study Topics for common intention, mens rea, homicide, general exceptions, sexual offences, property, and the IPC → BNS converter.
- s. 106(2) (hit-and-run) is marked not in force. Number traps (BNS 304 = snatching, BNS 309 = robbery) are called out on the converter page.
