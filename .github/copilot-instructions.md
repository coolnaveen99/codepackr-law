...
9. **Deep student answers** — `.github/instructions/student-answer-content.md`. Do not stop at a Bare Act summary. Every substantive topic must teach the concept, elements, exceptions, cases, examples, application, and a 10-mark / 16-mark answer framework.
