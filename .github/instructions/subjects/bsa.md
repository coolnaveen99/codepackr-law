...
- Study Topics must meet [`.github/instructions/student-answer-content.md`](../student-answer-content.md). Every section page `s-<n>` is a full student study note (meaning, every definition, illustrations, ingredients, application, 10-mark and 16-mark frameworks, full Q&A). Never a Bare Act dump. Never a shortened Q&A. Cite **BSA** section numbers for current law (in force 1 July 2024). IEA numbers are historical concordance only.
