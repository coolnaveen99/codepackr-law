...
- Study Topics must meet [`.github/instructions/student-answer-content.md`](../student-answer-content.md). Theme notes are exam essays. Every section page `s-<n>` is a **full student study note**: meaning, every definition/clause, ingredients, every statutory illustration and explanation, application, 10-mark and 16-mark frameworks, and full Q&A. Never a Bare Act dump. Never a shortened Q&A.
